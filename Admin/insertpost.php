...
<div class="col-md-8">
  <h3 class="page-header">Insert New Post here!</h3>
  <div class="row">
  <div class="col-md-12">
...
<div class="col-md-9">
 <textarea type="textarea" class="form-control" rows="5" placeholder="Description" name="post_content" required></textarea>
 </div>
</div>
</div>
<div class="form-group">
